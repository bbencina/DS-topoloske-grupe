...
S pomočjo strukturnih preslikav bomo sedaj definiramo topološko grupo.
...
\begin{primer}
	Realna števila za operacijo $+$ niso topološka grupa s topologijo $\tau = \lbrace (a, \infty) ; a \in \R \rbrace$. Vzemimo odprto množico $(a, \infty)$ in si oglejmo njeno prasliko glede na preslikavo invertiranja. Res $\iota((a, \infty)) = (-\infty, -a)$ ni odprta množica v topologiji $\tau$, torej prostor $(\R, \tau)$ ni topološka grupa.
...
%prestrukturiraj trditev v ntse
