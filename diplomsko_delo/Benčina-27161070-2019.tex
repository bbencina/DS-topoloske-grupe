...
V tem podpoglavju bomo ponovili nekaj pojmov iz splošne topologije, ki jih bomo kasneje podrobneje študirali na topoloških grupah.
...
\item \emph{Notranjost} množice $A$ je množica vseh njenih notranjih točk. Notranjost množice označimo z $\interior(A)$. Očitno velja $\interior(A) \subseteq A$ in tudi $\interior(A) = A \iff A \in \tau$.
