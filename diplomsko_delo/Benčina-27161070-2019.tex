...
\begin{enumerate}
\item Leva translacija $x \mapsto ax$ in desna translacija $x \mapsto xa$ za $a$ sta homeomorfizma iz $G$ v $G$
\item Invertiranje $x \mapsto x^{-1}$ je homeomorfizem iz $G$ v $G$.
\item Konjugiranje $x \mapsto axa^{-1}$ je homeomorfizem iz $G$ v $G$.
\end{enumerate}
\end{trditev}
