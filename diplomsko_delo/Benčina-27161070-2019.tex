...
Naj bo $\widetilde{\Ucurl}$ družina vseh končnih presekov množic iz družine $\lbrace xU ;\; x \in G, U \in \Ucurl \rbrace$.
...
\end{align*}
Ker je preslikava $f$ po predpostavki odprta, je $f(U)$ odprta množica v $\widetilde{G}$. Torej je preslikava $\Phi^{-1}$ odprta, iz česar sledi, da je $\Phi$ zvezna preslikava. Sledi, da je $\Phi$ homeomorfizem.
\end{dokaz}
...
Ker je po definiciji psevdometrike $\sigma(a, a) = 0$, je $\psi(a) = 1$.
...
Da preverimo točko (\ref{podtrd:prosta1}), vzamemo poljubno reducirano besedo $x_1^{\delta_1}\cdots x_n^{\delta_n}$ dolžine $n$, sestavljeno iz elementov prostora $X$.
